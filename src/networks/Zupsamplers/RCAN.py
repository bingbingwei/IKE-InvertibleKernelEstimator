...
class RCAN(nn.Module):
    def __init__(self, conv=common.default_conv, conf=None):
        ...
        modules_head = [conv(self.n_colors*3, n_feats, kernel_size)]
        ...
        modules_tail = [
            ...
            # TODO
            conv(n_feats, self.n_colors*3, kernel_size)]
    ...
    def forward(self, x, is_normed=False):
        if not is_normed:
            x = self.swap_and_norm(x)
